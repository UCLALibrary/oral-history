...
#    }
    ...
    config.add_show_field 'language_t', highlight: true, label: 'Language'
    ...
    config.add_show_field 'audio_b', highlight: true, label: 'Audio', helper_method: 'audio_icon'
    config.add_show_field 'links_t', highlight: true, label: 'Files', helper_method: 'file_links'
    config.add_show_field 'abstract_t', highlight: true, label: 'Series Statement'
    config.add_show_field 'interview_abstract_t', highlight: true, label: 'Abstract'
